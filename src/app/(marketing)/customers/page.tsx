...
export const metadata = buildMetadata({
  title: 'Customers',
  description:
    'How AI teams in fintech, HR tech, and healthcare software use Veydria to keep compliance close to the systems it describes.',
  path: '/customers'
});
...
const stories: Story[] = [
  ...
  },
  {
    ...
    quote: 'We knew screening was high risk. Veydria told us precisely what that meant for us.',
    ...
    <div className='mx-auto max-w-6xl px-4 py-16 sm:px-6'>
      <div className='max-w-3xl'>
        ...
        <p className='text-muted-foreground mt-4 text-lg text-pretty'>
          The teams that get the most out of Veydria treat compliance as part of building, not a
      ...
      <div className='mt-12 grid gap-4 md:grid-cols-3'>
        {stories.map((story) => (
          ...
          >
            ...
            <p className='text-foreground/80 mt-3 text-sm font-medium'>With Veydria</p>
